...
const rellenarRegiones = () => {  
    for (const i in region_comuna.regiones) {
        let option = document.createElement("option");
        option.value = region_comuna.regiones[i].numero;
        option.text = region_comuna.regiones[i].nombre;
...
const actualizarComunas = () => {
    ...
    for (const i in region_comuna.regiones) {
        if (region_comuna.regiones[i].numero == regionSeleccionada) {
            region_comuna.regiones[i].comunas.forEach(comuna => {
                let option = document.createElement("option");
...
// ---------- ACTIVAR SELECT E INPUT INICIAL ----------
